...
(function(w){
    ...
    heatmap.prototype = {
        ...
        init: function(){
                ...
                canvas.style.top = acanvas.style.top = 20;
                canvas.style.left = acanvas.style.left = 20;
                //mic change from 0  to 20
        ...
        colorize: function(x, y){
                ...
                for(var i=3; i < length; i+=4){
                    ...
                    imageData[i] = opacity;//(alpha < opacity)?alpha:opacity;
                }
        ...
        drawAlpha: function(x, y, count){
                ...
                /*console.log(r1+" r1 "+r2+" r2 "+ max+" max"); 
                console.log(ctx);  
                console.log(rgr);   
                console.log(((count)?(count/me.store.max):'0.1'));
                console.log(x+","+y);
                console.log(xb+" xb "+yb+" yb "+ mul+" mul"); */
                // the center of the radial gradient has .1 alpha value
                console.log(x+','+y+','+','+count+'='+((count)?(count/me.store.max):'0.1'));
                rgr.addColorStop(0, 'rgba(0,0,0,'+((count)?(count/me.store.max):'0.1')+')'); 
                //mic use this for legend 
